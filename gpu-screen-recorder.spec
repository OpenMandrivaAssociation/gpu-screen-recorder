...
# Use... git clone --branch 5.15.2 --depth 1 https://repo.dec05eba.com/gpu-screen-recorder
# for now lets choose tag instead of commit, so use 5.15.2
# then create .xz archive gpu-screen-recorder-5.15.2.tar.xz
